...
function updateEPIViz() {
    ...
    d3.select("#svgCDA").selectAll('circle')
    .data(cdaData.filter(d => {
        return d['CDA.ind.' + ctx_em.year_gdp] != -8888
    ...
    .join(
        enter => (
            enter.append("circle")
                .attr("cx", function (d, i) { return ctx_epi.xscale(parseFloat(d.gdp) / 1000) + 40; })
                .attr("cy", function (d, i) { return ctx_epi.yscale(d['CDA.ind.' + ctx_em.year_gdp]) + 27 })
                .attr("r", 3)
                .attr("stroke", function (d, i) { return d.country == ctx_globe.selectedCountry ? "red" : "#dbb867" })
                .attr("fill", "none")
                .attr("fill", function (d, i) { return d.country == ctx_globe.selectedCountry ? "red" : "none" })
                .attr("stroke-width", 1)
                .append("title")
                .text((d) => (d.country))),
    update => (
    ...
    d3.select("#svgTCL").selectAll('circle')
    .data(tclData.filter(d => {
        return d['TCL.ind.' + ctx_em.year_gdp] != -8888
    ...
    .join(
        enter => (
            enter.append("circle")
                .attr("cx", function (d, i) { return ctx_epi.xscale(parseFloat(d.gdp) / 1000) + 40; })
                .attr("cy", function (d, i) { return ctx_epi.yscale(d['TCL.ind.' + ctx_em.year_gdp]) + 27 })
                .attr("r", 3)
    ...
    d3.select("#svgPMD").selectAll('circle')
    .data(pmdData.filter(d => {
        return d['PMD.ind.' + ctx_em.year_gdp] != -8888
    ...
    .join(
        enter => (
            enter.append("circle")
                .attr("cx", function (d, i) { return ctx_epi.xscale(parseFloat(d.gdp) / 1000) + 40; })
                .attr("cy", function (d, i) { return ctx_epi.yscale(d['PMD.ind.' + ctx_em.year_gdp]) + 27 })
                .attr("r", 3)
    ...
    d3.select("#svgREC").selectAll('circle')
    .data(ctx_epi.recData.filter(d => {
        return d['REC.ind.' + ctx_em.year_gdp] != -8888
    ...
    .join(
        enter => (
            enter.append("circle")
                .attr("cx", function (d, i) { return ctx_epi.xscale(parseFloat(d.gdp) / 1000) + 40; })
                .attr("cy", function (d, i) { return ctx_epi.yscale(d['REC.ind.' + ctx_em.year_gdp]) + 27 })
                .attr("r", 3)
